...
export default {
  ...
  setup() {
    ...
    // console.log(searchAndBookmarkData);
    // let searchAndBookmarkData = {
    //   Liste: {
    //     key: "title",
    //     data: []
    //   },
    ...
    //   }
    // }
    // searchAndBookmarkData.Liste.data = allSearchAndBookmarkData.Liste.data.filter(element => this.$can(element.title, "dd"))
    const {
      searchQuery,
      resetsearchQuery,
      filteredData,
