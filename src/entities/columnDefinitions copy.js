...
export const getColumnDefinitionForList = entityName => {
    return entities[entityName].fields.map(element => {
        return {
            field: element.field,
            headerName: element.label.fr,
...
export const getEntityApiURI = entityName => {
    return entities[entityName].apiURI;
};
...
export const getBreadcrumbList = (entityName, locale = 'fr') => {
    ...
    const baseCrumbs = (entity.breadcrumb || []).map(text => ({
        text,
    }));
...
const entities = {
    Vendor: {
        ...
        fields: [
            ...
            { field: 'globalDimension1Code', label: { fr: 'Code axe principal 1', en: '', ar: '' }, showList: false, showCard: true, type: 'String', tooltip: { fr: '', en: '', ar: '' }, tab: 1 },
            { field: 'globalDimension2Code', label: { fr: 'Code axe principal 2', en: '', ar: '' }, showList: false, showCard: true, type: 'String', tooltip: { fr: '', en: '', ar: '' }, tab: 1 },
            ...
            { field: 'pricesIncludingVAT', label: { fr: 'Prix TTC', en: '', ar: '' }, showList: false, showCard: true, type: 'String', tooltip: { fr: '', en: '', ar: '' }, tab: 1 },
    ...
    PaymentMethod: [defaultFields.noDescription, ...auditFields],
    ...
    SalesPersonPurchaser: [defaultFields.contact, ...auditFields],

    ShipmentAgent: [defaultFields.contact, ...auditFields],

    Territory: [defaultFields.noName, ...auditFields],
};
