<template>
    ...
    <b-row class="content-header">
        ...
        <b-col class="content-header-right text-md-right mb-1" sm="12" md="7" lg="5">
            ...
            <b-button variant="relief-success" class="btn-icon" v-if="$can('WRITE', componentName)" @click="newClicked">
                <feather-icon icon="PlusIcon" />
                <!-- <span class="align-middle">Nouveau</span> -->
            </b-button>

        </b-col>


        <b-col v-if="showSearchBar" cols="12">
            <!-- Input -->
            <b-form-group>
                <b-input-group class="input-group-merge">
                    ...
                    <b-form-input id="icons-search" ref="icons-search" v-model="inputSearch" @input="updateSearchQuery"
