            ...
            <b-row>
                ...
                <b-col cols="12">
                    <b-form-group label="Famille">
                        <v-select class="select-size-sm" v-model="entity.family" label="description"
...
export default {
    ...
    data() {
        return {
            ...
            selectedEntity: null,
            componentName: "ItemSubFamily",
            componentAPI: "item_sub_family",
            breadcrumbData: {
                title: "Sous-familles d'articles",
                route: [
                    {
                        text: "Article",
                    },
                    {
                        text: "Sous-familles d'articles",
                        active: true,
                    },
                ],
                withFilter: false
    ...
    methods: {
        ...
        async save() {
            ...
            try {
                if (this.entity.family != null)
                    this.entity.family = this.entity.family.no;
                else
