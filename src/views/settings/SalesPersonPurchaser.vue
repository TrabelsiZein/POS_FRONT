            ...
            <b-row>
                ...
                <b-col cols="12">
                    <b-form-group label="Nom">
                        <b-form-input v-model="entity.name" />
                    </b-form-group>
                </b-col>

                <b-col cols="12">
                    <b-form-group label="Email">
                        <b-form-input v-model="entity.email" />
                    </b-form-group>
                </b-col>

                <b-col cols="12">
                    <b-form-group label="Téléphone">
                        <b-form-input v-model="entity.phone" />
                    </b-form-group>
                </b-col>
...
export default {
    ...
    data() {
        return {
            ...
            selectedEntity: null,
            componentName: "SalesPersonPurchaser",
            componentAPI: "sales_person_purchaser",
            breadcrumbData: {
                title: "Liste Des Vendeurs/Acheteurs",
                route: [
                    {
                        text: 'Configuration',
                    },
                    {
                        text: 'Vendeurs/Acheteurs',
                        active: true,
                    },
                ],
                withFilter: false
